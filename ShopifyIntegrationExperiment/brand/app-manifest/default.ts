export const app = {
  name: "ShopifyIntegrationExperiment",
  slug: "ShopifyIntegrationExperiment",
  scheme: "shopifyintegrationexperiment",
}

export const ios = {
  icon: "./brand/assets/default/app-icon/ios-universal.png",
  bundleIdentifier: "com.shopifyintegrationexperiment",
  splash: {
...
export const android = {
  ...
  package: "com.shopifyintegrationexperiment",
  splash: {
    image: "./brand/assets/default/splash-screen/logo.png",
    backgroundColor: "#191015",
  },
